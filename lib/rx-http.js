...
var ConnectionError = function (_CustomError2) {
  _inherits(ConnectionError, _CustomError2);

  function ConnectionError(url, message) {
    _classCallCheck(this, ConnectionError);

    var _this2 = _possibleConstructorReturn(this, (ConnectionError.__proto__ || Object.getPrototypeOf(ConnectionError)).call(this, message || 'Error connecting to ' + url));
...
var PropertyValidationError = function (_CustomError3) {
  _inherits(PropertyValidationError, _CustomError3);
  ...
  function PropertyValidationError(property, value, msg) {
    ...
    var _this3 = _possibleConstructorReturn(this, (PropertyValidationError.__proto__ || Object.getPrototypeOf(PropertyValidationError)).call(this, message));
...
var NoSerializerFoundError = function (_CustomError4) {
  _inherits(NoSerializerFoundError, _CustomError4);

  function NoSerializerFoundError(contentType) {
    _classCallCheck(this, NoSerializerFoundError);

    var _this4 = _possibleConstructorReturn(this, (NoSerializerFoundError.__proto__ || Object.getPrototypeOf(NoSerializerFoundError)).call(this, 'No serializer found for content type ' + contentType));
...
var NoDeserializerFoundError = function (_CustomError5) {
  _inherits(NoDeserializerFoundError, _CustomError5);

  function NoDeserializerFoundError(contentType) {
    _classCallCheck(this, NoDeserializerFoundError);

    var _this5 = _possibleConstructorReturn(this, (NoDeserializerFoundError.__proto__ || Object.getPrototypeOf(NoDeserializerFoundError)).call(this, 'No deserializer found for content type ' + contentType));

    _this5.contentType = contentType;
    return _this5;
  }
...
function property(name, member, value) {
  ...
  if (isValid(value)) {
    ...
    throw new _errors2.default.PropertyValidationError(name, value);
  }
}
...
function parseHeaders(rawHeaders) {
  ...
  if (rawHeaders) {
    ...
    headerLines.forEach(function (line) {
      ...
      if (idx > 0) {
        var headerName = line.substring(0, idx);
        var headerValue = line.substring(idx + 2);
...
var Serializer = function () {
  ...
  _createClass(Serializer, [{
    ...
    value: function serialize(value) {
      throw new _errors2.default.NotImplementedError();
    }
  }]);
...
var _formDataSerializer = __webpack_require__(25);

var _formDataSerializer2 = _interopRequireDefault(_formDataSerializer);

var _jsonSerializer = __webpack_require__(26);

var _jsonSerializer2 = _interopRequireDefault(_jsonSerializer);

var _textSerializer = __webpack_require__(27);
...
var _methodOverride = __webpack_require__(18);

var _bodyTransformer = __webpack_require__(16);

var _xsrf = __webpack_require__(19);

var _errorHandling = __webpack_require__(17);
...
var _xhrBuilder = __webpack_require__(20);

var _xhrBuilder2 = _interopRequireDefault(_xhrBuilder);

var _response = __webpack_require__(24);

var _response2 = _interopRequireDefault(_response);

var _requestInterceptorChain = __webpack_require__(21);

var _requestInterceptorChain2 = _interopRequireDefault(_requestInterceptorChain);

var _responseInterceptorChain = __webpack_require__(23);
...
function XHRProvider(request) {
  ...
  function attempt(observable) {
    ...
    var uploadProgress = request.uploadProgress();
    var downloadProgress = new _rxjs2.default.BehaviorSubject({ loaded: 0, total: 0 });
    ...
    var xhr = new _xhrBuilder2.default().request(request).onHeadersReceived(function (evt) {
      response = new _response2.default({
        ...
        headers: (0, _utilities.parseHeaders)(xhr.getAllResponseHeaders()),
        body: body,
    ...
    }).onError(responseError).onAbort(errorAll).onLoadEnd(function () {
      if (!failed) {
        completeAll();
      }
    }).build();
    ...
    var requestChain = new _requestInterceptorChain2.default(interceptors, success, responseError);
...
var _interceptors2 = __webpack_require__(9);
...
var _serializers = __webpack_require__(5);
...
var contentTypeSerializers = {
  'text/json': _serializers2.default.Json,
  'application/json': _serializers2.default.Json,
  'multipart/form-data': _serializers2.default.Form,
  'application/x-www-urlencoded': _serializers2.default.Form,
  'text/plain': _serializers2.default.Text
};
...
function autoDetect(body, contentType) {
  ...
  if ((0, _lodash.isString)(body)) {
    return new _serializers2.default.Text(contentType);
  }
  ...
  if ((0, _lodash.isObject)(body)) {
    if ((0, _utilities.isFormData)(body) || (0, _utilities.isFile)(body) || (0, _utilities.isBlob)(body) || Object.entries(body).some(function (entry) {
      ...
      return new _serializers2.default.Form(contentType);
    }

    return new _serializers2.default.Json(contentType);
  }

  throw new _errors2.default.NoSerializerFoundError('unknown');
}
...
var BodyTransformer = function (_Interceptor) {
  ...
  _createClass(BodyTransformer, [{
    ...
    value: function request(_request, accept, reject) {
      ...
      if (!!body) {
        var serializer = _request.serializer() || autoDetect(body, _request.contentType());
        var contentType = _request.contentType() || serializer.contentType;

        if (!!contentType) {
          _request.contentType(contentType);
        }

        _request.body(serializer.serialize(body));
      }
    ...
    value: function build() {
      ...
      xhr.addEventListener('readystatechange', function (evt) {
        if (xhr.readyState === STATE.HEADERS_RECEIVED) {
          ...
          try {
            if (xhr.status === 0) {
              self.error(new _errors2.default.ConnectionError(request.url().toString()));
            }
          } catch (err) {
            self.error(err);
          }
...
var _url2 = __webpack_require__(6);
...
var Request = function () {
  ...
  function Request() {
    ...
    _uploadProgress.set(this, new _rxjs2.default.BehaviorSubject({ loaded: 0, total: 0 }));
  }
  ...
  _createClass(Request, [{
    ...
    value: function url(value) {
      ...
      throw new _errors2.default.PropertyValidationError('url', value);
    }
...
var _headers2 = __webpack_require__(8);
...
var FormDataSerializer = function (_Serializer) {
  ...
  function FormDataSerializer(contentType) {
    ...
    return _possibleConstructorReturn(this, (FormDataSerializer.__proto__ || Object.getPrototypeOf(FormDataSerializer)).call(this, contentType));
  }
