...
var NotImplementedException = function (_CustomError) {
  _inherits(NotImplementedException, _CustomError);

  function NotImplementedException(message) {
    _classCallCheck(this, NotImplementedException);

    return _possibleConstructorReturn(this, (NotImplementedException.__proto__ || Object.getPrototypeOf(NotImplementedException)).call(this, message || 'Not Implemented'));
  }
...
var PropertyValidationException = function (_CustomError2) {
  _inherits(PropertyValidationException, _CustomError2);
   ...
   * @param value
   */
  function PropertyValidationException(property, value, msg) {
    _classCallCheck(this, PropertyValidationException);

    var message = msg || 'Value ' + value + ' is not valid for property ' + property;

    var _this2 = _possibleConstructorReturn(this, (PropertyValidationException.__proto__ || Object.getPrototypeOf(PropertyValidationException)).call(this, message));
...
/**
 * @class
 * @name NoSerializerFoundException
 */


var NoSerializerFoundException = function (_CustomError3) {
  _inherits(NoSerializerFoundException, _CustomError3);

  function NoSerializerFoundException(contentType) {
    _classCallCheck(this, NoSerializerFoundException);

    var _this3 = _possibleConstructorReturn(this, (NoSerializerFoundException.__proto__ || Object.getPrototypeOf(NoSerializerFoundException)).call(this, 'No serializer found for content type ' + contentType));
...
/**
 * @class
 * @name NoDeserializerFoundException
 */


var NoDeserializerFoundException = function (_CustomError4) {
  _inherits(NoDeserializerFoundException, _CustomError4);

  function NoDeserializerFoundException(contentType) {
    _classCallCheck(this, NoDeserializerFoundException);

    var _this4 = _possibleConstructorReturn(this, (NoDeserializerFoundException.__proto__ || Object.getPrototypeOf(NoDeserializerFoundException)).call(this, 'No deserializer found for content type ' + contentType));

    _this4.contentType = contentType;
    return _this4;
  }

  return NoDeserializerFoundException;
}(CustomError);

exports.default = {
  NotImplementedException: NotImplementedException,
  PropertyValidationException: PropertyValidationException,
  NoSerializerFoundException: NoSerializerFoundException,
  NoDeserializerFoundException: NoDeserializerFoundException
};
...
var Serializer = function () {
  ...
  _createClass(Serializer, [{
    ...
    value: function serialize(value) {
      throw new _exceptions.NotImplementedException();
    }
  }]);
...
exports.Serializers = exports.Serializer = exports.Exceptions = exports.Interceptors = exports.Interceptor = exports.Headers = exports.Http = exports.Url = undefined;
...
function autoDetect(body, contentType) {
  ...
  if (!!contentType && contentTypeSerializers[contentType.toLowerCase()]) {
    ...
    throw new _exceptions.NoSerializerFoundException(contentType);
  }

  throw new _exceptions.NoSerializerFoundException('unknown');
}
